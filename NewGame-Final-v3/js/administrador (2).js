...
const cantidad = document.getElementById('Exis_jue')
...
document.getElementById("AgregarBoton").addEventListener("click", function (event) 
{
    ...
    if (ID_jue == '' || Nom_jue == '' || Des_jue == '' || Pre_jue == '' || Exis_jue == '' || Genero == ''|| Port_juego == '') 
    {
...
window.addEventListener('load', () => {
    ...
    for (let e = 0; e < videojuegos.length; e++) {
        ...
        <td>${videojuegos[e].cantidadJue}</td>
