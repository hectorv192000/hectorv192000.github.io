const container = document.querySelector(".zoomimagen")
...
// let isZoomEnabled = false;      //IAAAA

container.addEventListener("mousemove", zoomImage)

        //IA
// image.addEventListener("mouseover", () => { isZoomEnabled = true; })
// image.addEventListener("mouseout", () => { isZoomEnabled = false; })
